        ...
        for file_path in csv_files:
            ...
            for col_name in df_sample.columns:
                ...
                if "int" in str(col_type):
                    ...
                    # فحص المحتوى الفعلي للعمود لتحديد التواريخ بأمان
                    non_null_series = df_sample[col_name].dropna()
                    is_date = False
                    
                    if not non_null_series.empty:
                        try:
                            # يحاول تحويل القيم لتاريخ، وإذا فشل يلقي Exception
                    ...
                    if is_date or "datetime" in str(col_type):
                        ...
                        sql_type = "NVARCHAR(255)"  # Catch-all safe default for text data
                    
                # Append the formatted table field script string with brackets for SQL safety
